...
const MENTAL_LESSON_METADATA: Record<string, LessonMetadata> = {
  ...
  mental_l02: lessonMetadata({
    ...
    insight_layer: {
      surprising_question: "頭に浮かんだ最悪ケースは、どれくらい事実？",
      research_finding: "不安は未来の推測を事実のように扱うほど強まりやすい",
      critical_caveat: "危険確認そのものをやめる lesson ではない",
      usable_scope: "返信が遅い、予定が崩れそうなど、確認できる情報が残っている場面で使える",
      practice_prompt: "事実 / 推測 / 次の確認、に1つずつ分ける",
    },
