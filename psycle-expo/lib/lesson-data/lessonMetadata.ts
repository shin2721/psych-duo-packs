...
const MENTAL_LESSON_METADATA: Record<string, LessonMetadata> = {
  mental_l01: lessonMetadata({
    ...
    lane: "core",
    lesson_job: "焦りを出来事・解釈・身体反応の3タイプで仮診断する",
    target_shift: "焦りを性格や出来事のせいだけにせず、自分の増幅パターンとして見分ける",
    done_condition: "焦った時に3タイプのどれが強いか選び、10秒ラベルで次の一手へ戻れる",
    takeaway_action: "焦りを感じたら「身体が反応している」と10秒だけラベルを貼る",
    insight_layer: {
      surprising_question: "焦りは出来事ではなく、自分の増幅タイプで強くなる？",
      research_finding: "ストレス反応は出来事の評価・身体反応・注意の向きで強まりやすい",
      critical_caveat: "現実の危険や体調不良を無視するための診断ではない",
      usable_scope: "電車遅延や返信待ちなど、日常の軽い焦りに最初のラベルを貼る時に使える",
      practice_prompt: "出来事タイプ / 解釈タイプ / 身体反応タイプ、から選ぶ",
    },
    load_score: loadScore(2, 3, 3),
