export const ja = {
    ...
    course: {
        ...
        world: {
            ...
            weekOneNextTitle: 'DAY %{day}/7：あと %{xp} XPで今日の印',
            weekOneNextBody: '次の3分で「%{action}」を使える形にします。',
            weekOneNextCta: '今日の印をつける',
            weekOneCompleteTitle: 'DAY %{day}/7：明日の続きができました',
            weekOneCompleteBody: '今日は完了。次は「%{lesson}」から静かに続けられます。',
            weekOneCompleteCta: '続きだけ見る',
            weekOneAccessibilityHint: '初回7日間の次の学習導線を開きます。',
            weekOneFallbackTitle: '次のレッスン',
            weekOneFallbackAction: '今日の心理スキル',
