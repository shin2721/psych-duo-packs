export const fr = {
    ...
    shop: {
        ...
        errors: {
            ...
            iosExternalCheckoutDisabled: 'Les abonnements sont temporairement indisponibles sur iOS pendant la préparation du paiement App Store.',
        },
        energyStatus: {
            title: 'État de l’énergie',
            currentLabel: 'Actuel : ',
            currentUnlimitedA11y: 'Énergie actuelle : illimitée avec Pro',
    ...
    lesson: {
        ...
        continue: 'Continuer',
        habitLoop: {
            title: 'Le pas utile du jour est terminé',
            body: 'Retourne au cours. Si tu as encore de l’énergie, la prochaine courte étape t’attend.',
            next: 'Suite : revenir au parcours',
        },
        completionRecap: {
    ...
    course: {
        ...
        streakRepair: {
            accessibilityHint: 'Dépensez des gemmes pour restaurer votre série.',
        },
        comebackReward: {
            accessibilityHint: 'Commencez une leçon pour recevoir votre récompense de retour.',
        },
        mastery: {
            title: 'Une leçon plus profonde est prête',
            body: 'Vous pouvez approfondir le même thème sous un autre angle. Il reste %{count} emplacements.',
            cta: 'Approfondir',
            accessibilityHint: 'Ouvrir une leçon de mastery pour ce thème.',
        },
        world: {
            ...
            supportBudgetRemaining: 'Il reste %{total} aides courtes cette semaine, dont %{kind} de ce type.',
