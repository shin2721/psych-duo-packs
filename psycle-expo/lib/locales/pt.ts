export const pt = {
    ...
    shop: {
        ...
        errors: {
            ...
            iosExternalCheckoutDisabled: 'As assinaturas estão temporariamente indisponíveis no iOS enquanto o pagamento da App Store é preparado.',
        },
        energyStatus: {
    ...
    lesson: {
        ...
        continue: 'Continuar',
        habitLoop: {
            title: 'O passo útil de hoje foi concluído',
            body: 'Volte ao curso. Se ainda tiver energia, o próximo passo curto está esperando.',
            next: 'Próximo: voltar ao caminho do curso',
        },
        completionRecap: {
    ...
    questionTypes: {
        ...
        swipeYourAnswer: 'Sua resposta: %{answer}',
