export const en = {
    ...
    shop: {
        ...
        errors: {
            ...
            iosExternalCheckoutDisabled: 'Subscriptions are temporarily unavailable on iOS while App Store billing is prepared.',
    ...
    lesson: {
        ...
        continue: 'Continue',
        habitLoop: {
            title: 'Today’s useful step is done',
            body: 'Return to the course. If you still have energy, the next short step is waiting.',
            next: 'Next: back to the course path',
        },
        completionRecap: {
    ...
    course: {
        ...
        mastery: {
            title: 'A deeper lesson is ready',
            body: 'You can deepen the same theme from another angle. %{count} slots remain.',
            cta: 'Go deeper',
            accessibilityHint: 'Open a mastery lesson for this theme.',
        },
        world: {
            ...
            goalRemainingTitle: '%{xp} XP left for today',
            goalRemainingBody: 'Complete one short lesson and keep your flow going.',
            goalRemainingCta: 'Do it now',
            goalCompleteTitle: 'Today’s goal is done',
            goalCompleteBody: 'Keep the flow going with the next lesson.',
            goalCompleteCta: 'Continue',
            goalCardAccessibilityHint: 'Open today’s learning path.',
            weekOneNextTitle: 'DAY %{day}/7: %{xp} XP to mark today',
            weekOneNextBody: 'In the next 3 minutes, turn "%{action}" into something you can use.',
            weekOneNextCta: 'Mark today',
            weekOneCompleteTitle: 'DAY %{day}/7: tomorrow has a clear next step',
            weekOneCompleteBody: 'Today is complete. Next time, continue quietly from "%{lesson}".',
            weekOneCompleteCta: 'Preview the next step',
            weekOneAccessibilityHint: 'Open the next learning step for the first seven days.',
            weekOneFallbackTitle: 'the next lesson',
            weekOneFallbackAction: 'today’s psychology skill',
            supportBudgetRemaining: '%{total} short support slots left this week. %{kind} of this kind remain.',
