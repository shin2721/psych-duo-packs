export const en = {
    ...
    quests: {
        ...
        v2: {
            ...
            boostTicketQueued: 'Queued ticket valid on %{date}',
            ...
            autoClaimSummary: 'Auto-claimed rewards',
            autoClaimGems: '+%{gems} Gems',
            autoClaimFreeze: 'Freeze +%{count}',
            autoClaimBadge: 'Monthly badge unlocked',
            autoClaimTicketBlocked: 'Ticket queue is full, so this ticket could not be granted',
