...
export const trailsByGenre: Record<string, any[]> = {
  mental: [
    ...
    { id: "m4", status: "locked", icon: "star", type: "lesson", lessonId: "mental_lesson_4" },
    { id: "m5", status: "locked", icon: "heart-circle", type: "lesson", lessonId: "mental_lesson_5" },
    { id: "m6", status: "locked", icon: "pulse", type: "lesson", lessonId: "mental_lesson_6" },
    { id: "m7", status: "locked", icon: "happy", type: "lesson", lessonId: "mental_lesson_7" },
    { id: "m8", status: "locked", icon: "sunny", type: "lesson", lessonId: "mental_lesson_8" },
    { id: "m9", status: "locked", icon: "moon", type: "lesson", lessonId: "mental_lesson_9" },
    { id: "m10", status: "locked", icon: "trophy", type: "lesson", lessonId: "mental_lesson_10" },
  ],
  money: [
